Contributing to Smartmeme Core
============================

The Smartmeme Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/The-Smartmeme-Endeavor/smartmeme/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Smartmeme Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Smartmeme
Network Protocol consensus changes.

Whether a pull request is merged into Smartmeme Core rests with the project merge
...
Patches that change Smartmeme consensus rules are considerably more involved than
...
Where a patch set proposes to change the Smartmeme consensus, it must have been
...
The review process is normally fairly responsive on the Smartmeme Core repository, however
...
The project leader is the release manager for each Smartmeme Core release.
