...
if [ "$uname_S" = "Darwin" ]; then
    PARAMS_DIR="$HOME/Library/Application Support/SmartmemeParams"
else
    PARAMS_DIR="$HOME/.smartmeme-params"
fi
...
DOWNLOAD_URL="https://github.com/The-Smartmeme-Endeavor/smartmeme/releases/tag/1.2.15.3"
...
Failed to fetch the Smartmeme parameters!
...
This script will fetch the Smartmeme SNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Smartmeme SNARK parameters. Note that it is
