...
rm -f src/config/smartmeme-config.h
...
rm -rf test_bitcoin.coverage/ smartmeme-gtest.coverage/ total.coverage/
...
clean_exe src/smartmeme-cli
clean_exe src/smartmemed
clean_exe src/smartmeme-gtest
clean_exe src/smartmeme-tx
clean_exe src/test/test_smartmeme
clean_exe src/test/test_smartmeme_fuzzy
...
clean_dep . src/config/smartmeme-config.h.in
