...
Smartmeme now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start smartmeme-address monthly-payment-smartmeme```
...
Format: ```mngovernance submit proposal-name url payment-count block-start smartmeme-address monthly-payment-smartmeme fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single smartnode (using smartmeme.conf setup)
