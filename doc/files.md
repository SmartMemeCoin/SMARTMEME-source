...
* smartmeme.conf: contains configuration settings for smartmemed or smartmeme-qt
* smartmemed.pid: stores the process id of smartmemed while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by smartmemed or smartmeme-qt
