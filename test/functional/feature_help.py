...
"""Verify that starting smartmemed with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start smartmemed with -h for help text")
        ...
        self.log.info("Start smartmemed with -version for version information")
