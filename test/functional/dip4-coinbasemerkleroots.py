...
class LLMQCoinbaseCommitmentsTest(SmartmemeTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SmartmemeTestFramework doesn't support this atm)
