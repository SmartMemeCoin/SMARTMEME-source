...
CAmount AmountFromValue(const UniValue& value, bool p_isSMME)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Smartmeme Core server stopping";
}
...
{
    return "> smartmeme-cli " + methodname + " " + args + "\n";
}
