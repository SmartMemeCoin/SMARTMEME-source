...
#error Client version information missing: version is not defined by smartmeme-config.h or in any other way
#endif
...
/**
 * smartmemed-res.rc includes this file, but it cannot cope with real c++ code.
