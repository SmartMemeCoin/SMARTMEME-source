    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  smartmeme-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Smartmeme in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 SMME, 1 SMME, 10 SMME, 100 SMME and 1000 SMME -- sort of like the paper money you use every day.</li> \
